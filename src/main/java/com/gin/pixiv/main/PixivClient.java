...
import com.gin.pixiv.enums.Headers;
import com.gin.pixiv.enums.Language;
import com.gin.pixiv.enums.Method;
import com.gin.pixiv.enums.ParamType;
import com.gin.pixiv.exception.PixivException;
import com.gin.pixiv.exception.PixivExceptionEnum;
import com.gin.pixiv.interceptor.LoggingInterceptor;
import com.gin.utils.JsonUtils;
import com.gin.utils.ObjectUtils;
...
public class PixivClient {
    ...
    private static String findToken(OkHttpClient client, String host, String phpSessionId) throws PixivException, IOException {
        final Request request = new Request.Builder().url(host + "/setting_user.php")
                .header(com.gin.pixiv.enums.Headers.REFERER, DEFAULT_HOST)
                .header(com.gin.pixiv.enums.Headers.COOKIE, "PHPSESSID=" + phpSessionId).build();
...
//                        urlBuilder.addQueryParameter(k, "");
    ...
    public Call call(
        ...
        final Request.Builder builder = new Request.Builder().url(httpUrl)
                .header(com.gin.pixiv.enums.Headers.REFERER, DEFAULT_HOST)
                .header(com.gin.pixiv.enums.Headers.COOKIE, this.cookie)
