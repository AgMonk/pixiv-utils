...
import org.gin.pixiv.response.body.tag.SuggestByWordBody;
import org.gin.pixiv.response.body.tag.TagInfo;
...
public class TagApi {
     ...
     * 查询标签建议(追加标签或搜索时使用)
     * @param keyword 关键字
     * @return {@link org.gin.pixiv.call.PixivCallStandard< SuggestByWordBody >}
