...
public class PixivUrlBuilder {
     ...
     * @return this
     */
    public PixivUrlBuilder addParam(String key, Object value) {
     ...
     * @return this
     */
    public PixivUrlBuilder setParams(Object o) {
        this.params = JsonUtils.jsonToMap(o);
        return this;
    }

    public PixivUrlBuilder setUrl(String urlTemplate, Object... args) {
